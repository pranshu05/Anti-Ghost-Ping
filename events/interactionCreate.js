...
module.exports = {
    ...
    async execute(interaction){
        ...
        .setTimestamp()
        if(!interaction.isCommand()) return interaction.reply(`${interaction.user} **>> interaction isn't a valid command!**`)
        if(!interaction.guild) return interaction.reply(`${interaction.user} **>> You can use slash commands only in a server!**`)
